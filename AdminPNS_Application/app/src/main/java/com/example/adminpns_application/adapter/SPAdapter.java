...
import com.example.adminpns_application.QuanLySanPhamActivity;
...
public class SPAdapter extends RecyclerView.Adapter<SPAdapter.ViewHolder> {
    ...
    QuanLySanPhamActivity quanLySanPhamActivity;


    public SPAdapter(Context context, ArrayList<SanPham> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.masp.setText(String.valueOf(list.get(position).getMaSp()));
        holder.tensp.setText(String.valueOf(list.get(position).getTenSp()));
        holder.hangsp.setText(String.valueOf(list.get(position).getMahang()));
        holder.km.setText(String.valueOf(list.get(position).getMaKm()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            linear = itemView.findViewById(R.id.linearopen);
        }
    }
